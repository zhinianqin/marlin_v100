...
class Sm70MoeMxfp4IteratorB {
 public:
  ...
  static_assert(Shape::kK == kCtaK,
                "SM70 Marlin MoE MXFP4 IteratorB expects CTA_K=32.");
...
struct Sm70MoeMxfp4GemmSpec {
  ...
  using IteratorB = Sm70MoeMxfp4IteratorB<Shape, ThreadMap, GroupSize>;
};

template <int CtaM, int CtaN, int Warps, int GroupSize>
using Sm70MoeMxfp4GemmTraits =
    Sm70MarlinMoeGemmTraits<Sm70MoeMxfp4GemmSpec, CtaM, CtaN, Warps,
                            GroupSize>;
