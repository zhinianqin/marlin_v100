...
constexpr char const* kSm70MarlinMoeNvfp4CtaEnv =
    "SM70_MARLIN_MOE_NVFP4_CTA";
constexpr char const* kSm70MarlinMoeNvfp4SplitKEnv =
    "SM70_MARLIN_MOE_NVFP4_SPLIT_K";
...
struct Sm70MoeNvfp4Launcher {
  ...
  torch::Tensor operator()() const {
    ...
    return launch_sm70_marlin_moe_gemm<Traits>(
        ...
        kSm70MarlinMoeNvfp4SplitKEnv, moe_block_size, top_k, mul_topk_weights,
...
torch::Tensor sm70_marlin_nvfp4_gemm(
  ...
  Sm70CtaGeometry const geometry =
      resolve_sm70_marlin_moe_cta_geometry(kSm70MarlinMoeNvfp4CtaEnv, size_n);
  check_sm70_marlin_moe_cta_geometry(kSm70MarlinMoeNvfp4CtaEnv, geometry);
  check_sm70_marlin_moe_cta_n_alignment(kSm70MarlinMoeNvfp4CtaEnv, geometry,
                                        size_n);
  TORCH_CHECK(size_k % kCtaK == 0,
              "SM70 Marlin MoE NVFP4 requires K divisible by 32. Got K=",
              size_k, ".");

  int const split_k = parse_sm70_split_k(kSm70MarlinMoeNvfp4SplitKEnv);
