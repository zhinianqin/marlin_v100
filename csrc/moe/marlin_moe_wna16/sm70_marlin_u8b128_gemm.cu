...
constexpr char const* kSm70MarlinMoeU8B128CtaEnv =
    "SM70_MARLIN_MOE_U8B128_CTA";
constexpr char const* kSm70MarlinMoeU8B128SplitKEnv =
    "SM70_MARLIN_MOE_U8B128_SPLIT_K";
...
class Sm70MoeU8B128IteratorB {
 public:
  ...
  static_assert(Shape::kK == kCtaK,
                "SM70 Marlin MoE U8B128 IteratorB expects CTA_K=32.");
...
struct Sm70MoeU8B128GemmSpec {
  ...
  using IteratorB = Sm70MoeU8B128IteratorB<Shape, ThreadMap, GroupSize>;
};

template <int CtaM, int CtaN, int Warps, int GroupSize>
using Sm70MoeU8B128GemmTraits =
    Sm70MarlinMoeGemmTraits<Sm70MoeU8B128GemmSpec, CtaM, CtaN, Warps,
                            GroupSize>;
...
struct Sm70MoeU8B128Launcher {
  ...
  torch::Tensor operator()() const {
    using Traits = Sm70MoeU8B128GemmTraits<CtaM, CtaN, Warps, GroupSize>;
    return launch_sm70_marlin_moe_gemm<Traits>(
        ...
        kSm70MarlinMoeU8B128SplitKEnv, moe_block_size, top_k, mul_topk_weights,
...
torch::Tensor sm70_marlin_u8b128_gemm(
  ...
  Sm70CtaGeometry const geometry =
      resolve_sm70_marlin_moe_cta_geometry(kSm70MarlinMoeU8B128CtaEnv,
                                           size_n);
  check_sm70_marlin_moe_cta_geometry(kSm70MarlinMoeU8B128CtaEnv, geometry);
  check_sm70_marlin_moe_cta_n_alignment(kSm70MarlinMoeU8B128CtaEnv, geometry,
                                        size_n);
  TORCH_CHECK(size_k % kCtaK == 0,
              "SM70 Marlin MoE U8B128 requires K divisible by 32. Got K=",
              size_k, ".");

  int const split_k = parse_sm70_split_k(kSm70MarlinMoeU8B128SplitKEnv);
  ...
  Sm70MoeU8B128Launcher const launcher{
