...
torch::Tensor sm70_marlin_u8b128_gemm(
  ...
  auto const params = sm70_marlin_moe_auto_stage_params(
      "U8B128", group_size, moe_block_size, top_k, size_m, size_n, size_k);
  ...
  TORCH_CHECK(size_k % geometry.cta_k == 0,
              "SM70 Marlin MoE U8B128 requires K divisible by CTA_K=",
  ...
  if (params.use_metadata_vector_words) {
    ...
    return dispatch_sm70_marlin_moe_geometry(
        launcher, geometry, params.packed_macro_n, group_size, "U8B128");
  }
