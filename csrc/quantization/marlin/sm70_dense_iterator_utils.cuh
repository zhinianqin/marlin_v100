...
CUTLASS_DEVICE int u4_macro_n_qweight_offset_from_logical(int size_n,
  ...
  int const n_tiles = size_n / kQuantTileN;
  ...
  int const remaining_n_tiles = n_tiles - macro_first_n_tile;
  int const subtile_count =
      remaining_n_tiles < kMacroNTiles ? remaining_n_tiles : kMacroNTiles;
