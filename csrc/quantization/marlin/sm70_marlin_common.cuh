...
sm70_marlin_dense_try_select_bjk110_qwen3_5_122b_a10b_abliterated_awq_params(
  ...
  if (ctx.size_n == 1536
    ...
    if (ctx.size_m == 1) {
      ...
      return set_params({64, 64, 64, 8, 32, 32, 32}, 2, true);
    } else {
      return set_params({128, 256, 32, 8, 64, 64, 32}, 1, false);
    }
  } else if (ctx.size_n == 3072
          && ctx.size_k == 1024) {
    if (ctx.size_m == 1) {
      ...
      return set_params({64, 64, 32, 8, 32, 32, 16}, 1, true);
    } else {
      return set_params({128, 256, 32, 8, 64, 64, 32}, 1, false);
    }
  } else if (ctx.size_n == 3072
...
sm70_marlin_dense_try_select_bjk110_qwen3_5_122b_a10b_abliterated_fp8_params(
  ...
  if (ctx.group_size == -1
  ...
  } else if (ctx.group_size == 128
          && ctx.size_n == 256
          && ctx.size_k == 3072) {
    if (ctx.size_m == 1) {
      return set_params({64, 64, 64, 4, 64, 32, 32}, 8, false);
    } else if (ctx.size_m == 32) {
    ...
    if (ctx.size_m == 1) {
      ...
      return set_params({128, 128, 32, 8, 32, 64, 32}, 1, true);
    } else {
      return set_params({128, 256, 32, 8, 64, 64, 32}, 1, false);
    }
  } else if (ctx.group_size == 128
    ...
    if (ctx.size_m <= 32) {
      ...
      return set_params({128, 256, 32, 8, 64, 64, 32}, 1, true);
          ...
          && ctx.size_k == 2048) {
    if (ctx.size_m == 1) {
      return set_params({32, 128, 32, 4, 32, 64, 16}, 8, false);
    } else if (ctx.size_m == 32) {
      return set_params({32, 64, 64, 4, 32, 64, 16}, 4, true);
    } else if (ctx.size_m == 64) {
      return set_params({64, 64, 128, 8, 32, 64, 32}, 1, true);
    } else {
      return set_params({128, 256, 32, 8, 64, 64, 32}, 1, true);
    }
  } else if (ctx.group_size == 128
...
sm70_marlin_dense_try_select_bjk110_qwen3_5_122b_a10b_abliterated_nvfp4_params(
  ...
  if (ctx.size_n == 256
  ...
  } else if (ctx.size_n == 512
          && ctx.size_k == 3072) {
    if (ctx.size_m == 1) {
      return set_params({32, 128, 32, 4, 32, 64, 16}, 8, true);
    } else if (ctx.size_m <= 64) {
      return set_params({32, 64, 64, 4, 32, 32, 32}, 4, true);
    } else if (ctx.size_m == 2048) {
      return set_params({64, 128, 32, 4, 32, 64, 32}, 1, true);
    } else {
      return set_params({256, 64, 32, 4, 64, 64, 32}, 1, true);
    }
  } else if (ctx.size_n == 2560
          && ctx.size_k == 3072) {
    if (ctx.size_m == 1) {
    ...
    if (ctx.size_m == 1) {
      ...
      return set_params({64, 64, 64, 8, 32, 64, 16}, 1, true);
    } else if (ctx.size_m == 2048) {
      return set_params({128, 128, 32, 8, 64, 32, 32}, 1, true);
    } else {
      return set_params({128, 256, 32, 8, 64, 64, 32}, 1, true);
    }
  } else if (ctx.size_n == 4608
          && ctx.size_k == 3072) {
    if (ctx.size_m == 1) {
      return set_params({32, 128, 32, 4, 32, 32, 32}, 8, true);
    } else if (ctx.size_m == 32) {
...
inline bool
sm70_marlin_dense_try_select_bjk110_qwen3_5_122b_a10b_abliterix_fp8_params(
    Sm70MarlinDenseAutoParamsContext const& ctx,
    Sm70MarlinAutoParams& params) {
  if (ctx.quant_format == nullptr ||
      std::strcmp(ctx.quant_format, "fp8_e4m3") != 0 ||
  ...
  if (ctx.size_n == 256
          && ctx.size_k == 3072) {
    if (ctx.size_m == 1) {
      return set_params({64, 64, 32, 4, 64, 32, 16}, 8, false);
    } else if (ctx.size_m <= 64) {
      return set_params({32, 64, 64, 4, 32, 32, 32}, 4, true);
    } else if (ctx.size_m == 2048) {
      return set_params({64, 128, 128, 8, 64, 64, 32}, 1, true);
    ...
    if (ctx.size_m <= 32) {
      ...
      return set_params({64, 64, 64, 8, 32, 32, 32}, 1, true);
    } else {
      return set_params({128, 256, 32, 8, 64, 64, 32}, 1, true);
    }
  } else if (ctx.size_n == 3072
...
inline bool
sm70_marlin_dense_try_select_bjk110_qwen3_5_122b_a10b_abliterix_nvfp4_params(
    Sm70MarlinDenseAutoParamsContext const& ctx,
    Sm70MarlinAutoParams& params) {
  if (ctx.quant_format == nullptr ||
      std::strcmp(ctx.quant_format, "nvfp4") != 0 ||
  ...
  if (ctx.size_n == 256
    ...
    if (ctx.size_m == 1) {
      ...
      return set_params({64, 64, 64, 8, 32, 64, 16}, 2, true);
    } else {
      return set_params({128, 256, 32, 8, 64, 64, 32}, 1, true);
    }
  } else if (ctx.size_n == 3072
    ...
    if (ctx.size_m == 1) {
      ...
      return set_params({256, 128, 32, 8, 64, 64, 32}, 1, true);
    }
  } else if (ctx.size_n == 3072
          && ctx.size_k == 1024) {
    if (ctx.size_m == 1) {
...
inline bool
sm70_marlin_dense_try_select_lhca521_minimax_m2_7_abliterated_heretic_ara_awq_params(
    Sm70MarlinDenseAutoParamsContext const& ctx,
    Sm70MarlinAutoParams& params) {
  if (ctx.quant_format == nullptr ||
      std::strcmp(ctx.quant_format, "uint4b8") != 0 ||
  ...
  if (ctx.size_n == 1024
    ...
    if (ctx.size_m == 1) {
      ...
      return set_params({64, 64, 64, 4, 64, 32, 32}, 4, true);
    } else if (ctx.size_m == 64) {
      return set_params({32, 64, 64, 4, 32, 32, 32}, 4, true);
    } else {
      return set_params({128, 256, 32, 8, 64, 64, 32}, 1, false);
...
sm70_marlin_dense_try_select_nvidia_glm_4_7_nvfp4_params(
  ...
  if (ctx.size_n == 384
    ...
    if (ctx.size_m == 1) {
      ...
      return set_params({64, 64, 32, 8, 32, 32, 16}, 1, false);
    } else if (ctx.size_m == 64) {
      return set_params({32, 128, 32, 4, 32, 64, 16}, 1, true);
    } else {
      return set_params({128, 256, 32, 8, 64, 64, 32}, 1, true);
  ...
  } else if (ctx.size_n == 6144
          && ctx.size_k == 5120) {
    if (ctx.size_m <= 32) {
      return set_params({32, 128, 32, 4, 32, 32, 32}, 4, true);
    } else if (ctx.size_m == 64) {
      return set_params({64, 128, 32, 4, 32, 64, 32}, 4, true);
    } else {
      return set_params({128, 256, 32, 8, 64, 64, 32}, 1, true);
    }
  }
...
sm70_marlin_dense_try_select_nvidia_qwen3_6_35b_a3b_nvfp4_params(
  ...
  } else if (std::strcmp(ctx.quant_format, "fp8_e4m3") == 0
          && ctx.group_size == -1
          && ctx.size_n == 2048
          && ctx.size_k == 512) {
    if (ctx.size_m == 1) {
  ...
  } else if (std::strcmp(ctx.quant_format, "nvfp4") == 0
          && ctx.group_size == 16
          && ctx.size_n == 128
          && ctx.size_k == 2048) {
    if (ctx.size_m == 1) {
...
sm70_marlin_dense_try_select_nvidia_qwen3_next_80b_a3b_thinking_nvfp4_params(
  ...
  if (ctx.size_n == 128
    ...
    if (ctx.size_m <= 32) {
      ...
      return set_params({128, 64, 32, 4, 64, 32, 32}, 1, true);
    }
  } else if (ctx.size_n == 2048
          && ctx.size_k == 64) {
    if (ctx.size_m == 1) {
    ...
    if (ctx.size_m == 1) {
      ...
      return set_params({128, 64, 32, 4, 64, 32, 32}, 1, false);
    } else {
      return set_params({128, 64, 32, 4, 32, 64, 32}, 1, true);
    }
  } else if (ctx.size_n == 2048
...
sm70_marlin_dense_try_select_quanttrio_glm_4_7_awq_params(
  ...
  if (ctx.has_bias == false
    ...
    if (ctx.size_m == 1) {
      ...
      return set_params({32, 64, 128, 4, 32, 64, 32}, 4, true);
    } else if (ctx.size_m == 64) {
      return set_params({32, 64, 64, 4, 32, 64, 16}, 4, true);
    } else if (ctx.size_m == 2048) {
      return set_params({128, 128, 32, 8, 64, 32, 32}, 1, true);
...
sm70_marlin_dense_try_select_quanttrio_qwen3_6_27b_awq_params(
  ...
  if (ctx.size_n == 4352
    ...
    if (ctx.size_m == 1) {
      ...
      return set_params({64, 64, 32, 4, 32, 64, 16}, 1, true);
    } else {
      return set_params({128, 256, 32, 8, 64, 64, 32}, 1, true);
    }
  } else if (ctx.size_n == 5120
...
sm70_marlin_dense_try_select_qwen_qwen3_6_27b_fp8_params(
  ...
  if (ctx.size_n == 2048
    ...
    if (ctx.size_m == 1) {
      ...
      return set_params({64, 64, 64, 8, 32, 32, 32}, 4, true);
    } else if (ctx.size_m == 2048) {
      return set_params({128, 256, 32, 8, 64, 64, 32}, 1, true);
    } else {
      return set_params({128, 256, 32, 8, 64, 64, 32}, 1, false);
    ...
    if (ctx.size_m == 1) {
      ...
      return set_params({64, 64, 32, 4, 32, 64, 16}, 4, true);
    } else if (ctx.size_m == 2048) {
      return set_params({128, 256, 32, 8, 64, 64, 32}, 1, true);
    } else {
      return set_params({128, 256, 32, 8, 64, 64, 32}, 1, false);
    ...
    if (ctx.size_m == 1) {
      ...
      return set_params({64, 128, 128, 8, 64, 64, 32}, 2, true);
    } else if (ctx.size_m == 2048) {
      return set_params({128, 256, 32, 8, 64, 64, 32}, 1, false);
    } else {
      return set_params({128, 256, 32, 8, 64, 64, 32}, 1, true);
    ...
    if (ctx.size_m == 1) {
      ...
      return set_params({32, 128, 64, 8, 32, 64, 16}, 1, true);
    } else {
      return set_params({128, 256, 32, 8, 64, 64, 32}, 1, true);
    }
  } else if (ctx.size_n == 5120
...
inline bool
sm70_marlin_dense_try_select_qwen_qwen3_6_35b_a3b_fp8_params(
    Sm70MarlinDenseAutoParamsContext const& ctx,
    Sm70MarlinAutoParams& params) {
  if (ctx.quant_format == nullptr ||
      std::strcmp(ctx.quant_format, "fp8_e4m3") != 0 ||
  ...
  if (ctx.group_size == -1
    ...
    if (ctx.size_m == 1) {
      ...
      return set_params({32, 64, 64, 4, 32, 64, 16}, 2, true);
    } else if (ctx.size_m == 64) {
      return set_params({32, 64, 64, 4, 32, 64, 16}, 1, false);
    } else {
      return set_params({128, 256, 32, 8, 64, 64, 32}, 1, true);
  ...
  if (ctx.size_n == 256
    ...
    if (ctx.size_m == 1) {
      ...
      return set_params({128, 256, 32, 8, 64, 64, 32}, 1, true);
          ...
          && ctx.size_k == 128) {
    if (ctx.size_m == 1) {
      return set_params({64, 64, 32, 4, 64, 32, 16}, 1, true);
    } else if (ctx.size_m == 32) {
      return set_params({64, 128, 32, 4, 32, 64, 32}, 1, true);
    } else if (ctx.size_m == 64) {
      return set_params({32, 64, 64, 4, 32, 32, 32}, 1, true);
    ...
    if (ctx.size_m <= 32) {
      ...
      return set_params({128, 256, 32, 8, 64, 64, 32}, 1, true);
          ...
          && ctx.size_k == 2048) {
    if (ctx.size_m == 1) {
      return set_params({64, 128, 32, 4, 32, 64, 32}, 8, true);
    } else if (ctx.size_m == 32) {
      return set_params({32, 64, 64, 4, 32, 64, 16}, 4, true);
    } else if (ctx.size_m == 64) {
      return set_params({32, 128, 128, 8, 32, 64, 32}, 1, true);
...
if (sm70_marlin_dense_try_select_quanttrio_glm_4_7_awq_params(ctx, params)) {
  ...
  if (sm70_marlin_dense_try_select_quanttrio_qwen3_6_27b_awq_params(ctx, params)) {
    validate_sm70_marlin_auto_params("Dense", params);
    return params;
  }
  if (sm70_marlin_dense_try_select_qwen_qwen3_5_122b_a10b_fp8_params(ctx, params)) {
    validate_sm70_marlin_auto_params("Dense", params);
    return params;
  }
  if (sm70_marlin_dense_try_select_qwen_qwen3_6_27b_fp8_params(ctx, params)) {
    validate_sm70_marlin_auto_params("Dense", params);
    return params;
  }
  if (sm70_marlin_dense_try_select_qwen_qwen3_6_35b_a3b_fp8_params(ctx, params)) {
    validate_sm70_marlin_auto_params("Dense", params);
    return params;
  }
  if (sm70_marlin_dense_try_select_shifusen_qwen3_5_122b_a10b_abliterated_fp8_params(ctx, params)) {
    validate_sm70_marlin_auto_params("Dense", params);
    return params;
  }
  if (sm70_marlin_dense_try_select_bjk110_qwen3_5_122b_a10b_abliterated_awq_params(ctx, params)) {
    validate_sm70_marlin_auto_params("Dense", params);
    return params;
  }
  if (sm70_marlin_dense_try_select_bjk110_qwen3_5_122b_a10b_abliterated_fp8_params(ctx, params)) {
    validate_sm70_marlin_auto_params("Dense", params);
    return params;
  }
  if (sm70_marlin_dense_try_select_bjk110_qwen3_5_122b_a10b_abliterated_nvfp4_params(ctx, params)) {
    validate_sm70_marlin_auto_params("Dense", params);
    return params;
  }
  if (sm70_marlin_dense_try_select_bjk110_qwen3_5_122b_a10b_abliterix_fp8_params(ctx, params)) {
    validate_sm70_marlin_auto_params("Dense", params);
    return params;
  }
  if (sm70_marlin_dense_try_select_bjk110_qwen3_5_122b_a10b_abliterix_nvfp4_params(ctx, params)) {
    validate_sm70_marlin_auto_params("Dense", params);
    return params;
  }
  if (sm70_marlin_dense_try_select_cyankiwi_glm_4_7_awq_4bit_params(ctx, params)) {
    validate_sm70_marlin_auto_params("Dense", params);
    return params;
  }
  if (sm70_marlin_dense_try_select_cyankiwi_minimax_m2_7_awq_4bit_params(ctx, params)) {
    validate_sm70_marlin_auto_params("Dense", params);
    return params;
  }
  if (sm70_marlin_dense_try_select_cyankiwi_qwen3_6_27b_awq_bf16_nvfp4_params(ctx, params)) {
    validate_sm70_marlin_auto_params("Dense", params);
    return params;
  }
  if (sm70_marlin_dense_try_select_lhca521_minimax_m2_7_abliterated_heretic_ara_awq_params(ctx, params)) {
    validate_sm70_marlin_auto_params("Dense", params);
    return params;
  }
  ...
  if (sm70_marlin_dense_try_select_nvidia_qwen3_next_80b_a3b_thinking_nvfp4_params(ctx, params)) {
    validate_sm70_marlin_auto_params("Dense", params);
    return params;
  }
  if (sm70_marlin_dense_try_select_nvidia_qwen3_6_35b_a3b_nvfp4_params(ctx, params)) {
    validate_sm70_marlin_auto_params("Dense", params);
    return params;
  }
